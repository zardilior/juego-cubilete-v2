...
// src/blocks/controls/index.tsx
var LazyColorControl = lazy(() => import("./_browser-chunks/Color-KMSTOMOX.js")), ColorControl = (props) => React15.createElement(Suspense, { fallback: React15.createElement("div", null) }, React15.createElement(LazyColorControl, { ...props }));
...
var usePrimaryStory = () => {
  let context = useContext6(DocsContext), stories = context.componentStories();
