...
declare const ArgTypes: React__default.ComponentType<ArgTypesProps>;
...
declare const Story: React__default.ComponentType<StoryProps>;
...
declare const Canvas: React__default.ComponentType<CanvasProps>;
...
declare const Controls: React__default.ComponentType<ControlsProps>;
...
declare const Description: React__default.ComponentType<DescriptionProps>;
...
declare const DocsStory: React__default.ComponentType<DocsStoryProps>;
...
declare const Heading: React__default.ComponentType<PropsWithChildren<HeadingProps>>;
...
declare const Markdown: React__default.ComponentType<Omit<React__default.HTMLAttributes<Element>, "children"> & {
    children: string;
...
declare const Primary: React__default.ComponentType<{}>;

interface StoriesProps {
    title?: ReactElement | string;
    includePrimary?: boolean;
}
declare const Stories: React__default.ComponentType<StoriesProps>;

declare const Subheading: React__default.ComponentType<PropsWithChildren<HeadingProps>>;
...
declare const Subtitle: React__default.ComponentType<SubtitleProps>;
...
declare const Title: React__default.ComponentType<TitleProps>;

declare const Unstyled: React__default.ComponentType<React__default.DetailedHTMLProps<React__default.HTMLAttributes<HTMLDivElement>, HTMLDivElement>>;

declare const Wrapper: React__default.ComponentType<React__default.DetailedHTMLProps<React__default.HTMLAttributes<HTMLDivElement>, HTMLDivElement>>;
