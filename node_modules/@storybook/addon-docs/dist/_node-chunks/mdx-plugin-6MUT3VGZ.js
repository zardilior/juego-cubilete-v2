...
import {
  compile
} from "./chunk-CW3VPTDC.js";
import "./chunk-3TGPCCME.js";
import "./chunk-KPMO7MQ3.js";
import {
  __commonJS,
  __toESM
} from "./chunk-II4NL54B.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-G32C2TP7.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-HFKK6QKY.js")).default;
  return {
