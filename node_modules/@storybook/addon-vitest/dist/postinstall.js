import CJS_COMPAT_NODE_URL_iir1e5cw7r from 'node:url';
import CJS_COMPAT_NODE_PATH_iir1e5cw7r from 'node:path';
import CJS_COMPAT_NODE_MODULE_iir1e5cw7r from "node:module";

var __filename = CJS_COMPAT_NODE_URL_iir1e5cw7r.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_iir1e5cw7r.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_iir1e5cw7r.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-IAQCBIY5.js";
import {
  require_dist
} from "./_node-chunks/chunk-FWVQQKZI.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-YYRTOCV4.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-YQF2TELZ.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-VPR4MZCW.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-JXLUGFAL.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config.template-TAB7SH3W.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4.template-BHJGNR5T.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2.template-K7G7OH2K.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace.template-JCFWO4PC.js");
    default:
