...
*/
export declare function applyPatch(object: any, patch: Operation[], options?: Options): (import("./patch").MissingError | import("./patch").TestError | import("./patch").InvalidOperationError | null)[];
/**
