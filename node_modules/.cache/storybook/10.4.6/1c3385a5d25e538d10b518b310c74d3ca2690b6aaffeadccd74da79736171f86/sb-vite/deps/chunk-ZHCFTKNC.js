...
var LazyColorControl = (0, import_react6.lazy)(() => import("./Color-KMSTOMOX-VA7DT2XT.js"));
...
var Preview = ({
  ...
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), [copied, setCopied] = (0, import_react27.useState)(null), [scale, setScale] = (0, import_react27.useState)(1), additionalActionItems = (0, import_react27.useMemo)(
    ...
    let { createCopyToClipboardFunction } = await import("./components-64URZJ6Y.js");
...
var SourceWithCode = (props) => {
  let docsContext = (0, import_react68.useContext)(DocsContext), sourceProps = useSourceProps(props, docsContext, EMPTY_SOURCE_CONTEXT);
  return import_react68.default.createElement(Source, { ...sourceProps });
};
...
var usePrimaryStory = () => {
  let context = (0, import_react74.useContext)(DocsContext), stories = context.componentStories();
  return context.filterByAutodocs === false ? stories[0] : stories.find((story) => story.tags.includes(import_preview_api3.Tag.AUTODOCS));
};
...
var DocsContainer = ({
  ...
  }), import_react79.default.createElement(DocsSluggerContext.Provider, { value: slugger }, import_react79.default.createElement(DocsContext.Provider, { value: context }, import_react79.default.createElement(SourceContainer, { channel: context.channel }, import_react79.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react79.default.createElement(
    DocsPageWrapper,
    {
...
var StoriesImpl = ({ title = "Stories", includePrimary = true }) => {
  var _a;
  let { componentStories, projectAnnotations, getStoryContext } = (0, import_react86.useContext)(DocsContext), stories = componentStories(), { stories: { filter } = { filter: void 0 } } = ((_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) || {};
...
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react90.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react90.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react91.useContext)(DocsContext);
...
//# sourceMappingURL=chunk-ZHCFTKNC.js.map
